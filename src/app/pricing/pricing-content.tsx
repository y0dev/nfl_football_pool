      ...
      <section style={{ background: surface, padding: '3rem 0' }}>
        <div className="lp-inner">
          ...
          <div style={{ maxWidth: 720, margin: '1.5rem auto 0' }}>
            ...
            <div style={{ background: card, border: `1px solid ${border}`, borderLeft: `3px solid ${gold}`, borderRadius: 10, padding: '1.5rem', display: 'flex', flexWrap: 'wrap', gap: '1.5rem', alignItems: 'flex-start', justifyContent: 'space-between' }}>
              ...
              <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: '0.6rem', flex: '1 1 220px', minWidth: 200 }}>
                ...
                <li style={{ ...b, fontSize: '0.78rem', color: textDim, lineHeight: 1.6, marginTop: '0.25rem' }}>
          ...
          <p style={{ ...b, fontSize: '0.85rem', color: textMid, textAlign: 'center', marginTop: '2rem' }}>
            Every plan also includes up to 2 free preseason-only pools (max 15 players each) — perfect for a test run before the season starts.
          </p>
          <p style={{ ...b, fontSize: '0.85rem', color: textMid, textAlign: 'center', marginTop: '0.75rem' }}>
