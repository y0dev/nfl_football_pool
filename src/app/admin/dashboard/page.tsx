      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
          <Card className="text-center">
            <CardContent className="p-4">
              ...
              <div className="text-2xl font-bold text-blue-600">{dashboardStats.totalPools}</div>
          ...
          <Card className="text-center">
            <CardContent className="p-4">
              ...
              <div className="text-2xl font-bold text-green-600">{dashboardStats.activePools}</div>
          ...
          <Card className="text-center">
            <CardContent className="p-4">
              ...
              <div className="text-2xl font-bold text-purple-600">{dashboardStats.totalParticipants}</div>
          ...
          <Card className="text-center">
            <CardContent className="p-4">
              ...
              <div className="text-2xl font-bold text-orange-600">{dashboardStats.totalGames}</div>
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              <div className="space-y-4">
                {/* Admin List */}
                <div>
                  <h4 className="font-medium mb-3">All Admins ({admins.length})</h4>
        ...
        <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-semibold text-blue-900 mb-2">Current Week: {currentWeek}</h3>
